...
class CategoryService implements CategoryServiceInterface
{
    ...
    protected $authService, $categoryRepo;
        ...
        , CategoryRepositoryInterface $categoryRepo)
    {
        ...
        $this->table_names = 'categories';
    }

    public function readAll()
    {
        $all = $this->categoryRepo->findAllActiveSkeleton();
    ...
    {
        $one = $this->categoryRepo->findOneActiveSkeleton($id);
    ...
    public function createOne($data)
    {
        ...
        try {
            ...
            $i_one = [
                'code'        => $this->categoryRepo->generateCode('CATEGORY'),
                'name'        => $data['name'],
                'description' => $data['description'],
                'active'      => true
            ];

            $one = $this->categoryRepo->createOne($i_one);
    ...
    public function updateOne($data)
    {
        ...
        try {
            ...
            $one = $this->categoryRepo->findOneActive($data['id']);
            ...
            $one = $this->categoryRepo->updateOne($one->id, $i_one);
    ...
    public function deactivateOne($id)
    {
        ...
        try {
            ...
            $one = $this->categoryRepo->deactivateOne($id);
    ...
    public function deleteOne($id)
    {
        ...
        try {
            ...
            $one = $this->categoryRepo->destroyOne($id);
    ...
    public function searchOne($filter)
    {
        ...
        $filtered = $this->categoryRepo->findAllActiveSkeleton();
        ...
        if($category_id != 0)
            $filtered = $filtered->where('id',$category_id);
